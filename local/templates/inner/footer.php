				...
				<div class="sb_sidebar">
					...
					<?$APPLICATION->IncludeComponent(
						...
						Array(
							...
							"DISPLAY_TOP_PAGER" => "N",
							"FIELD_CODE" => array(0=>"NAME",1=>"PREVIEW_TEXT",2=>"PREVIEW_PICTURE",3=>"DETAIL_TEXT",4=>"DETAIL_PICTURE",5=>"DATE_ACTIVE_FROM",6=>"DATE_ACTIVE_TO",7=>"",),
							"FILTER_NAME" => "",
					...
					<?$APPLICATION->IncludeComponent(
						...
						Array(
							...
							"CACHE_TYPE" => "A",
							"CHECK_DATES" => "Y",
							"COMPONENT_TEMPLATE" => "testimonials_random",
							"DETAIL_URL" => "",
